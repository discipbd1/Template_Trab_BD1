...
>> ##### Observações: <br> a) Relatório que mostre os tipos de equipamentos e  as suas respectivas quantidades. <br>  b) para os empregados que não possuirem alguma destas informações o valor no registro deve aparecer sem informação/nulo. 
