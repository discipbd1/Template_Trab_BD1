...
- :white_check_mark: [4. Prototipação](#4prototipação-perguntas-a-serem-respondidas-e-tabela-de-dados)
    ...
    - :white_check_mark: 4.3 [4.3 Tabela de dados do Sistema](#43-tabela-de-dados-do-sistema)
- :white_check_mark: [5. Modelo Conceitual](#5modelo-conceitual)
    - :white_medium_square:[5.1 Validação do Modelo conceitual](#51-validação-do-modelo-conceitual)
    - :white_medium_square:[5.2 Descrição dos dados](#52-descrição-dos-dados)
- :white_check_mark: [6. Modelo Lógico](#6-modelo-lógico)
- :white_medium_square:[7. Modelo Físico](#7-modelo-físico)
- :white_medium_square:[8. Insert Tabelas](#8-insert-aplicado-nas-tabelas-do-banco-de-dados)
- :white_medium_square:[9. Tabelas e Principais Consultas](#9-tabelas-e-principais-consultas)
    - :white_medium_square:[9.1 Consulta das tabelas com todos os dados inseridos](#91-consultas-das-tabelas-com-todos-os-dados-inseridos-todas)
***
## Entrega 2
***
- - :white_medium_square:[9.2 Consulta das tabelas com filtros `WHERE`](#92-consultas-das-tabelas-com-filtros-where-mínimo-4)
  ...
  - :white_medium_square:[9.9 Consultas com SELF JOIN e VIEW](#99-consultas-com-self-join-e-view-mínimo-6)
  - :white_medium_square:[9.10 Subconsultas](#910-subconsultas-mínimo-4)
***
## Entrega 3
***
